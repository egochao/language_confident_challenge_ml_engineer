...
class BcResNetModel(nn.Module):
    def __init__(self, n_class: int = 35, *, scale: int = 1, dropout: float = constants.DROPOUT, use_subspectral: bool = True):
        super().__init__()
...
class NormalBlock(nn.Module):
    def __init__(self, n_chan: int, *, dilation: int = 1, dropout: float = constants.DROPOUT, use_subspectral: bool = True):
        super().__init__()
...
class TransitionBlock(nn.Module):
    def __init__(self, in_chan: int, out_chan: int, *, dilation: int = 1, stride: int = 1, dropout: float = constants.DROPOUT, use_subspectral: bool = True):
        super().__init__()
